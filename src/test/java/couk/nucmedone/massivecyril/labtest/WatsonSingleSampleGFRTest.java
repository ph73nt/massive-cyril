...
import couk.nucmedone.massivecyril.labtest.SingleSampleGFR;
import couk.nucmedone.massivecyril.labtest.WatsonSingleSampleGFR;
...
public class WatsonSingleSampleGFRTest extends TestCase {
	...
	private DoublePlus singleSampleGFR(int patIndex, int sampleIndex)
		...
		// Empty GFR object
		SingleSampleGFR wsgfr = new WatsonSingleSampleGFR();
		// Add injection
